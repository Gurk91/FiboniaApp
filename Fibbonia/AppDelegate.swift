...
var currTutor: Tutor = Tutor(name: "", calEmail: "", gradyear: 0, subjects: [""], phone: "", zoom: "", setPrefs: false, preferences: ["languages": [], "location": []], img: "", firstlogin: true, prefTime:["0": [Int](), "1":[Int](), "2":[Int](), "3":[Int](), "4":[Int](), "5":[Int](), "6":[Int]()])
var defaultTutor: Tutor = Tutor(name: "", calEmail: "", gradyear: 0, subjects: [""], phone: "", zoom: "", setPrefs: false, preferences: ["languages": [], "location": []], img: "", firstlogin: true, prefTime:["0": [Int](), "1":[Int](), "2":[Int](), "3":[Int](), "4":[Int](), "5":[Int](), "6":[Int]()])
