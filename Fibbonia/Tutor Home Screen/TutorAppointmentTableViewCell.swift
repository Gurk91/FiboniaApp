//
//  TutorAppointmentTableViewCell.swift
//  Fibbonia
//
//  Created by Gurkarn Goindi on 3/Aug/20.
//  Copyright © 2020 Gurkarn Goindi. All rights reserved.
//

import UIKit

class TutorAppointmentTableViewCell: UITableViewCell {
    ...
    func setVals(input: [String: Any]) {
        ...
        print(input["studentName"] as! String, "set name label C")
